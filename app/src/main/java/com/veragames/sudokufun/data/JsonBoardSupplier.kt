...
val mockedBoard =
    listOf(
        Cell(value = '9', row = 0, col = 0, box = 0, completed = true),
        Cell(value = ' ', row = 0, col = 1, box = 0, completed = false),
        Cell(value = ' ', row = 0, col = 2, box = 0, completed = false),
        Cell(value = '4', row = 0, col = 3, box = 1, completed = true),
        Cell(value = '8', row = 0, col = 4, box = 1, completed = true),
        Cell(value = '7', row = 0, col = 5, box = 1, completed = true),
        Cell(value = '3', row = 0, col = 6, box = 2, completed = true),
        ...
        Cell(value = '2', row = 1, col = 3, box = 1, completed = true),
        Cell(value = '3', row = 1, col = 4, box = 1, completed = true),
        ...
        Cell(value = '3', row = 2, col = 0, box = 0, completed = true),
        ...
        Cell(value = '6', row = 2, col = 4, box = 1, completed = true),
        Cell(value = ' ', row = 2, col = 5, box = 1, completed = false),
        Cell(value = ' ', row = 2, col = 6, box = 2, completed = false),
        Cell(value = '7', row = 2, col = 7, box = 2, completed = true),
        Cell(value = ' ', row = 2, col = 8, box = 2, completed = false),
        Cell(value = ' ', row = 3, col = 0, box = 3, completed = false),
        Cell(value = '9', row = 3, col = 1, box = 3, completed = true),
        Cell(value = ' ', row = 3, col = 2, box = 3, completed = false),
        Cell(value = '3', row = 3, col = 3, box = 4, completed = true),
        Cell(value = ' ', row = 3, col = 4, box = 4, completed = false),
        Cell(value = ' ', row = 3, col = 5, box = 4, completed = false),
        Cell(value = '1', row = 3, col = 6, box = 5, completed = true),
        Cell(value = ' ', row = 3, col = 7, box = 5, completed = false),
        Cell(value = '7', row = 3, col = 8, box = 5, completed = true),
        Cell(value = '6', row = 4, col = 0, box = 3, completed = true),
        Cell(value = ' ', row = 4, col = 1, box = 3, completed = false),
        Cell(value = ' ', row = 4, col = 2, box = 3, completed = false),
        Cell(value = '1', row = 4, col = 3, box = 4, completed = true),
        Cell(value = '7', row = 4, col = 4, box = 4, completed = true),
        Cell(value = '9', row = 4, col = 5, box = 4, completed = true),
        Cell(value = ' ', row = 4, col = 6, box = 5, completed = false),
        Cell(value = '3', row = 4, col = 7, box = 5, completed = true),
        Cell(value = '4', row = 4, col = 8, box = 5, completed = true),
        Cell(value = '1', row = 5, col = 0, box = 3, completed = true),
        ...
        Cell(value = '5', row = 5, col = 7, box = 5, completed = true),
        Cell(value = '8', row = 5, col = 8, box = 5, completed = true),
        Cell(value = ' ', row = 6, col = 0, box = 6, completed = false),
        Cell(value = ' ', row = 6, col = 1, box = 6, completed = false),
        Cell(value = '1', row = 6, col = 2, box = 6, completed = true),
        Cell(value = '7', row = 6, col = 3, box = 7, completed = true),
        Cell(value = ' ', row = 6, col = 4, box = 7, completed = false),
        Cell(value = '4', row = 6, col = 5, box = 7, completed = true),
        Cell(value = ' ', row = 6, col = 6, box = 8, completed = false),
        Cell(value = ' ', row = 6, col = 7, box = 8, completed = false),
        Cell(value = '3', row = 6, col = 8, box = 8, completed = true),
        Cell(value = ' ', row = 7, col = 0, box = 6, completed = false),
        Cell(value = ' ', row = 7, col = 1, box = 6, completed = false),
        Cell(value = '3', row = 7, col = 2, box = 6, completed = true),
        Cell(value = '8', row = 7, col = 3, box = 7, completed = true),
        Cell(value = ' ', row = 7, col = 4, box = 7, completed = false),
        Cell(value = '6', row = 7, col = 5, box = 7, completed = true),
        Cell(value = '7', row = 7, col = 6, box = 8, completed = true),
        Cell(value = ' ', row = 7, col = 7, box = 8, completed = false),
        Cell(value = '2', row = 7, col = 8, box = 8, completed = true),
        Cell(value = ' ', row = 8, col = 0, box = 6, completed = false),
        Cell(value = '7', row = 8, col = 1, box = 6, completed = true),
        Cell(value = '9', row = 8, col = 2, box = 6, completed = true),
        Cell(value = '5', row = 8, col = 3, box = 7, completed = true),
        Cell(value = '1', row = 8, col = 4, box = 7, completed = true),
        Cell(value = '3', row = 8, col = 5, box = 7, completed = true),
        Cell(value = '4', row = 8, col = 6, box = 8, completed = true),
        Cell(value = '8', row = 8, col = 7, box = 8, completed = true),
        Cell(value = '6', row = 8, col = 8, box = 8, completed = true),
    )
