...
class BoardTest {
    ...
    fun setUp() {
        ...
        gameViewModel =
            GameViewModel(GameUseCases(loadBoardUseCase, getBoardUseCase, setCellValueUseCase))
    ...
    fun loads_board_on_screen() {
        gameViewModel.state.value.board.forEach {
            composeTestRule
                .onNodeWithTag("cell_${it.cell.row}_${it.cell.col}_${it.cell.box}_${it.cell.value}")
    ...
    fun sets_value_on_board() {
        composeTestRule.onNodeWithTag("cell_3_4_4_ ").performClick()
        composeTestRule.onNodeWithTag("value_FIVE").performClick()
        composeTestRule.onNodeWithTag("cell_3_4_4_5").assertExists().assertTextContains("5")
    }
}
